class Snapzap < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/EasyG0ing1/SnapZap/releases/download/1.0.5/snapzap-1.0.0-macos-x64.tar.gz"
      sha256 "22b3a8d4fdb0af6c377fe1c76017aac14c9d0672e8123fcdf67dea690a1f7214"
    end

    on_arm do
      url "https://github.com/EasyG0ing1/SnapZap/releases/download/1.0.5/snapzap-1.0.0-macos-arm64.tar.gz"
